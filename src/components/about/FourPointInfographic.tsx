...
type Item = { id: string; title: string; text: string; color: string; Icon: React.ElementType };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {items.map((item, idx) => {
          ...
          return (
            ...
            >
              {/* pill shell */}
              <div className="relative flex items-stretch gap-4 rounded-full border border-white/20 bg-white/10 backdrop-blur-xl shadow-lg">
                {/* left number block */}

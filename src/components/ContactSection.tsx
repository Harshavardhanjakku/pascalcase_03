...
export default function ContactSection() {
  ...
  const helperText = (key: keyof ContactFormState) => {
    ...
    return (
      <p id={`${formId}-${key}-error`} role="alert" className="mt-2 text-xs font-medium text-red-500 flex items-center gap-1">
        ...
        <div className="w-full max-w-2xl">
          ...
          >
            <header className="mb-4">
              <h2 id="contact-heading" className="text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>
                Contact Us
              </h2>
            ...
            <form noValidate onSubmit={onSubmit} className="space-y-4 contact-form" aria-describedby={submitted === 'ok' ? `${formId}-success` : undefined}>
              ...
              <div className="relative">
                ...
                />
                <label htmlFor={`${formId}-company`} className="form-label">Company</label>
                {helperText('company')}
              </div>
              ...
              <div className="relative">
                ...
                />
                <label htmlFor={`${formId}-message`} className="form-label">Message</label>
                {helperText('message')}
              </div>
              ...
              {submitted === 'ok' && (
                <div id={`${formId}-success`} className="mt-4 p-4 rounded-lg bg-green-50 border border-green-200 flex items-center gap-3">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a href="mailto:support@pascalcase.com" className="contact-icon" aria-label="Email support">
              ...
              <span className="ml-2 text-xs" style={{ color: 'var(--text-secondary)' }}>support@pascalcase.com</span>
            </div>
          </motion.div>
        </div>
      </div>
